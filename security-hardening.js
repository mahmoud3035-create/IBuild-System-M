...
function injectSharedSidebar(html) {
    ...
    if (payrollEnhancementScript && /id=["']payrollMonth["']/i.test(output) && !output.includes('payroll-enhancements.js')) output = output.replace(/<\/body>/i, `<script>\n${payrollEnhancementScript}\n</script>\n</body>`);
    if (payrollBridgeScript && /id=["']payrollMonth["']/i.test(output) && !output.includes('payroll-bridge.js')) output = output.replace(/<\/body>/i, `<script>\n${payrollBridgeScript}\n</script>\n</body>`);
    return output;
}
